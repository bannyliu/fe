...
exports.default = {
  ...
  //请求视频管理分类数据
  videoClassify: function videoClassify(that) {
    var uri = '/api/video/classify/list';
    var callback = function callback(res) {
      var arr = [];
  ...
  //请求视频阶段分类数据
  videoStage: function videoStage(that) {
    var uri = '/api/video/stage/list';
    var callback = function callback(res) {
      var arr = [];
      res.data.data.subjects.map(function (value, i) {
        arr.push(React.createElement(
...
var _qandaDetailContent = __webpack_require__(16);
...
var _adminHeader = __webpack_require__(52);
  ...
  _createClass(InterViewqUpdate, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'm-update' },
        _react2.default.createElement(_update2.default, { title: this.state.title })
      );
    }
  }]);
...
/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/BANNY/Desktop/fe/liubin/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "videoClassify.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
var _indexbanner = __webpack_require__(57);

var _indexbanner2 = _interopRequireDefault(_indexbanner);

var _indexVideo = __webpack_require__(55);

var _indexVideo2 = _interopRequireDefault(_indexVideo);

var _indexNews = __webpack_require__(53);
...
var _interviewq = __webpack_require__(58);

var _interviewq2 = _interopRequireDefault(_interviewq);

var _ListContent = __webpack_require__(18);
...
var qandaList = function (_React$Component) {
  ...
  _createClass(qandaList, [{
    key: 'getData',
    value: function getData(mes) {
      var _this2 = this;

      _axios2.default.get('/api/qanda/list', mes, function (res) {
        // console.log(res.data.data);
        var listData = res.data.data.subjects.map(function (comment, index) {
          return {
            id: comment.id,
...
var _searchContent = __webpack_require__(59);

var _searchContent2 = _interopRequireDefault(_searchContent);

var _searchContent3 = __webpack_require__(60);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            TabPane,
            { tab: '\u5168\u7AD9', key: '1' },
            _react2.default.createElement(_searchContent2.default, { data: this.state.searchBody, tab: 'all' })
          ),
          _react2.default.createElement(
            TabPane,
            { tab: '\u89C6\u9891', key: '2' },
            _react2.default.createElement(_searchContent2.default, { data: this.state.searchBody, title: '\u89C6\u9891', tab: 'video' })
          ),
          _react2.default.createElement(
            TabPane,
            { tab: '\u95EE\u7B54', key: '3' },
            _react2.default.createElement(_searchContent2.default, { data: this.state.searchBody, title: '\u95EE\u7B54', tab: 'qanda' })
          ),
          _react2.default.createElement(
            TabPane,
            { tab: '\u62DB\u8058', key: '4' },
            _react2.default.createElement(_searchContent2.default, { data: this.state.searchBody, title: '\u62DB\u8058', tab: 'job' })
          )
        )
      );
    }
...
var _UsersHeader = __webpack_require__(62);

var _UsersHeader2 = _interopRequireDefault(_UsersHeader);

var _UsersFooter = __webpack_require__(61);
    ...
    value: function titleData(tagData, curTag, changeTag) {
      ...
      var tagList = tagData.map(function (item, index) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'i',
            { id: index, className: curTag == item.tag ? "active" : "" || curTag == index ? "active" : "", onClick: changeTag.bind(_this2, item.tag, index) },
            item.tag
          )
        );
      });
...
var _indexList = __webpack_require__(33);
...
var _interviewqList = __webpack_require__(23);

var _interviewqList2 = _interopRequireDefault(_interviewqList);

var _interviewqAdd = __webpack_require__(22);

var _interviewqAdd2 = _interopRequireDefault(_interviewqAdd);

var _jobList = __webpack_require__(26);

var _jobList2 = _interopRequireDefault(_jobList);

var _jobAdd = __webpack_require__(25);

var _jobAdd2 = _interopRequireDefault(_jobAdd);

var _videoList = __webpack_require__(31);

var _videoList2 = _interopRequireDefault(_videoList);

var _videoAdd = __webpack_require__(29);

var _videoAdd2 = _interopRequireDefault(_videoAdd);

var _videoUpdate = __webpack_require__(32);

var _videoUpdate2 = _interopRequireDefault(_videoUpdate);

var _videoClassify = __webpack_require__(30);

var _videoClassify2 = _interopRequireDefault(_videoClassify);

var _stage = __webpack_require__(28);

var _stage2 = _interopRequireDefault(_stage);

var _jobUpdate = __webpack_require__(27);

var _jobUpdate2 = _interopRequireDefault(_jobUpdate);

var _interviewqUpdate = __webpack_require__(24);
...
var _jobList3 = __webpack_require__(34);
...
var _Forgotpwd = __webpack_require__(39);

var _Forgotpwd2 = _interopRequireDefault(_Forgotpwd);

var _Resetpwd = __webpack_require__(40);
  ...
  _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouter.Route, { path: 'classify', component: _videoClassify2.default }),
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _reactRouter.Link,
              { to: '/job/list', activeClassName: 'active' },
              '\u62DB\u8058'
            )
          )
        ),
...
var _indexNewsList = __webpack_require__(54);
...
var _indexCommon = __webpack_require__(15);
...
var _indexVideoList = __webpack_require__(56);
...
var _axios3 = __webpack_require__(7);
...
var _searchList = __webpack_require__(17);
